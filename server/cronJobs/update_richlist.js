...
var proc = spawn('/usr/bin/node', ['/var/www/html/chain.review/server/sync.js', wallet, 'updaterichlistandextrastats'], {execFileOpts, options}, function done(err, stdout, stderr) {
    if (err) {
