...
for (var wallet in settings) {
    if(settings[wallet].active) {
        ...
        // string += "* */2 * * * root sleep 0 && /usr/bin/node /var/www/html/chain.review/server/cronJobs/update_clusters_tx_chart.js " + wallet + " >> /var/www/html/chain.review/logs/" + wallet + "CronUpdateClustersTxChart.log 2>&1\n";
